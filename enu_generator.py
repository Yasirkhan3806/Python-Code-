...
# lets say that we have to make an order list of students we have this method that is 
# for i in range(len(students)):
#     print(i+ 1,students[i])
# but we have this builtin function called enumerate() which do the job for us
